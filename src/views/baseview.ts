 ...
 * 
 * File:			baseview.ts
 * Description:		Webview that serves as base class for other views like the MemoryDumpView.
...
/**
 * A Webview that serves as base class for other views like the MemoryDumpView.
 */
