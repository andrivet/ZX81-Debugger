 ...
 * 
 * File:			renderbase.ts
 * Description:		Common functions for RenderFlowChart, RenderCallGraph and RenderText (RenderHtml)
...
export class RenderBase {
    ...
    <style>
		body.vscode-light {
			--zx81debugger-fg-color: var(--vscode-editor-foreground);
			--zx81debugger-emphasize-color1: var(--vscode-editor-selectionBackground);
			--zx81debugger-emphasize-color2: var(--vscode-editor-inactiveSelectionBackground);
			--zx81debugger-emphasize-color3: #0000FF;
			--zx81debugger-emphasize-color4: #001080;
		}
		...
		body.vscode-dark {
			...
			--zx81debugger-emphasize-color1: var(--vscode-editor-selectionBackground);
			--zx81debugger-emphasize-color2: var(--vscode-editor-inactiveSelectionBackground);
			--zx81debugger-emphasize-color3: #569CD6;
			--zx81debugger-emphasize-color4: #9CDCFE;
		}
	...
	*/
	...
	protected getAllRefAddressesFor(subOrNode: AsmNode | Subroutine): string {
		...
		for (const addr of allAddresses) {
			const hrefAddress = this.disasm.funcFormatAddress(addr);
			s += hrefAddress + ';';
		}
		// Return
		return s;
	...
	protected adjustSvg(svg: string): string {
		svg = svg.replace(/#00FEFE/gi, 'var(--zx81debugger-fg-color)');
		svg = svg.replace(/#01FEFE/gi, 'var(--zx81debugger-emphasize-color1)');
		svg = svg.replace(/#02FEFE/gi, 'var(--zx81debugger-emphasize-color2)');
		svg = svg.replace(/#03FEFE/gi, 'var(--zx81debugger-emphasize-color3)');
		svg = svg.replace(/#04FEFE/gi, 'var(--zx81debugger-emphasize-color4)');
		// Strip tooltip (title)
