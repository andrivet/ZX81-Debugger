 ...
 * 
 * File:			format.ts
 * Description:		Formatting of data
...
export class Format {
	 ...
	 */
	public static formatDisassembly(memory: BaseMemory | undefined, clmnsAddress: number, clmnsBytes: number, clmnsOpcodeFirstPart: number, clmsnOpcodeTotal: number, address: number, size: number, mainString: string, addrString: string|undefined): string {
		let line = '';
